    ...
    <div class="code-overlay">
        {#if highlightRange}
            <div
                ...
                style="top: calc(0.75rem + {highlightRange.start} * 1.17rem); height: calc({highlightRange.end -
                    highlightRange.start} * 1.17rem)"
            ></div>
        {/if}
        <pre class="code-highlight" aria-hidden="true"><code
