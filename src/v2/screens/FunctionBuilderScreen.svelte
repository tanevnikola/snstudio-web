    ...
    >
        ...
        <div class="center-column">
            ...
            <div
                ...
                class:active={resizingYaml}
                onmousedown={startResizeYaml}
                role="separator"
                aria-label="Resize YAML panel"
            ></div>
            <YamlEditor
                yamlText={composerYaml}
                {highlightRange}
                style={yamlHeight ? `flex: 0 0 ${yamlHeight}px` : ""}
                onchange={(text) => {
                    composerYaml = text;
                }}
            />
